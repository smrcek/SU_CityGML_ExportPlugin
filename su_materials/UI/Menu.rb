require 'su_materials/Services/ExternalService'
    ...
    if (Sketchup.version.to_f < version_required)
      ...
      help_menu.add_item("About CityGML-Editor"){
        ...
        dlg.add_action_callback("get_version_build") {|d,p|
          script = 'print_version_build( "' + FHGelsenkirchenMaterials::CITYGML_VERSION + '", "' + FHGelsenkirchenMaterials::CITYGML_BUILD + '" );'
