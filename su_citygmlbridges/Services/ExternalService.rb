...
module FHGelsenkirchenBridges
  ...
  class FeedbackService
    def initialize
      ...
      result = ""
      result << %Q["#{str}"] +' '+ FHGelsenkirchenBridges::CITYGML_VERSION.to_s + ' ' + FHGelsenkirchenBridges::CITYGML_BUILD.to_s
      IO.popen(result)
    end
  end
  ...
  class UpdateService
    def initialize
      ...
      str = str.encode("WINDOWS-1252")
      result = ""
      result << %Q["#{str}"] +' '+ 'Editor '+ FHGelsenkirchenBridges::CITYGML_VERSION.to_s+' '+ FHGelsenkirchenBridges::CITYGML_BUILD.to_s
      IO.popen(result)
    end
  end
