...
module FHGelsenkirchenBuildings
  ...
  class FeedbackService
    def initialize
      ...
      result = ""
      result << %Q["#{str}"] +' '+ FHGelsenkirchenBuildings::CITYGML_VERSION.to_s + ' ' + FHGelsenkirchenBuildings::CITYGML_BUILD.to_s
      IO.popen(result)
    end
  end
  ...
  class UpdateService
    def initialize
      ...
      str = str.encode("WINDOWS-1252")
      result = ""
      result << %Q["#{str}"] +' '+ 'Editor '+ FHGelsenkirchenBuildings::CITYGML_VERSION.to_s+' '+ FHGelsenkirchenBuildings::CITYGML_BUILD.to_s
      IO.popen(result)
    end
  end
