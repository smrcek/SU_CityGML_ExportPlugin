require 'su_citygmlbuildings/Edit/selectBackMaterialSurfaces.rb'
require 'su_citygmlbuildings/Services/ExternalService'
...
module FHGelsenkirchenBuildings
  ...
  begin
    if (Sketchup.version.to_f < version_required)
      ...
      m2 = tool_menu.add_submenu("CityGML_Buildings"){}
      m2.add_item("Import"){
        ImportService.new()
      }
      m2.add_item("Export"){
      ...
      help_menu.add_item("About CityGML-Editor"){
        ...
        dlg.add_action_callback("get_version_build") {|d,p|
          script = 'print_version_build( "' + FHGelsenkirchen::CITYGML_VERSION + '", "' + FHGelsenkirchen::CITYGML_BUILD + '" );'
