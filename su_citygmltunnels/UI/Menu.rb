require 'su_citygmltunnels/Edit/selectBackMaterialSurfaces.rb'
require 'su_citygmltunnels/Services/ExternalService'
...
module FHGelsenkirchenTunnels
  ...
  begin
    if (Sketchup.version.to_f < version_required)
      ...
      m2 = tool_menu.add_submenu("CityGML_Tunnels"){}
      m2.add_item("Import"){
        ImportService.new()
      }
      m2.add_item("Export"){
      ...
      help_menu.add_item("About CityGML-Editor"){
        ...
        dlg.add_action_callback("get_version_build") {|d,p|
          script = 'print_version_build( "' + FHGelsenkirchenTunnels::CITYGML_VERSION + '", "' + FHGelsenkirchenTunnels::CITYGML_BUILD + '" );'
